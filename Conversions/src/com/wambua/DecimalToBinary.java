...
class DecimalToBinary {
    ...
    public static void main(String args[]) {
        ...
        conventionalConversion(input);
        bitwiseConversion(input);
        input.close();
    }


    /** This method converts a decimal number to a binary number using a conventional algorithm. */
    public static void conventionalConversion(Scanner input) {
        int n, b = 0, c = 0, d;
//        Scanner input = new Scanner(System.in);
...
//        input.close();
    ...
    public static void bitwiseConversion(Scanner input) {
        int n, b = 0, c = 0, d;
//        Scanner input = new Scanner(System.in);
